...
> {
    ...
    public addTask<
        Name extends string,
        InlineFnType extends (builder: any) => { inputsScope: any; outputsScope: any; retryParameters?: any },
        LoopT extends NonSerializedPlainObject = never,
    ...
    public addTask(name: any, sourceOrInline: any, keyOrFn?: any, ...restArgs: any[]): any {
        if (sourceOrInline === INLINE) {
            const inlineFn = keyOrFn as (builder: any) => { retryParameters?: any; inputsScope?: any; outputsScope?: any };
            const args = restArgs;
