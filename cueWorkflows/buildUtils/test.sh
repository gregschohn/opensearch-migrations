...
pushd lib
$CUE eval helpers.cue expressions.cue parameters.cue tests/expressionTest.cue --expression  '[Test.Expressions]'
$CUE eval helpers.cue parameters.cue tests/parameterTest.cue --expression  '[Test.Params]'
