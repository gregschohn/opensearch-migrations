def call(Map config = [:]) {
    ...
    def defaultTestIds = config.defaultTestIds ?: "0030,0041"
    ...
    pipeline {
        ...
        parameters {
            ...
            string(name: 'TEST_IDS', defaultValue: "${defaultTestIds}", description: 'Comma-separated test IDs to run (e.g. 0030,0041)')
