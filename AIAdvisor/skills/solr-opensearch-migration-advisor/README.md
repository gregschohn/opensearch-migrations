...
The agent connects to it at `http://opensearch-pricing-calculator:5050` by default. Override this with the `OPENSEARCH_PRICING_CALCULATOR_URL` environment variable if needed.
